...
getFormattedTime:function(){var c=new Date,a=c.getHours(),b=c.getMinutes(),d=c.getSeconds(),c=c.getMilliseconds(),a=""+a;a+=(b<10?":0":":")+b;a+=(d<10?":0":":")+d;a+=(c<10?",0":",")+c;return a},getErrorDetails:function(c){var a="";c!=null&&c!=""&&(a="\n -- Error Info --",a+="\n name: "+c.name,a+="\n number: "+c.number,a+="\n message: "+c.message,a+="\n description: "+c.description);return a},toConsole:function(){function c(a,c){var b=a.toLowerCase(),b=console[b];typeof b=="function"?b.call(console,
