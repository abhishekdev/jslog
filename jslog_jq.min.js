...
b+", setting level to NONE")};c.prototype.getLogLevel=function(){return this.level};c.prototype.isDebugEnabled=function(){return c.levels[this.getLogLevel()]>=c.levels.DEBUG};c.prototype.isInfoEnabled=function(){return c.levels[this.getLogLevel()]>=c.levels.INFO};c.prototype.isWarnEnabled=function(){return c.levels[this.getLogLevel()]>=c.levels.WARN};c.prototype.isErrorEnabled=function(){return c.levels[this.getLogLevel()]>=c.levels.ERROR};c.prototype.log=function(b,a){var f=c.levels[this.level]||
-1,e,b=b.toUpperCase();e=c.levels[b]||0;if(e===0)b="DEBUG",e=c.levels.DEBUG;f>=e&&(++this.counter,this.config.pipeConsole&&c.util.toConsole&&c.util.toConsole(b,a),this.ui.addLog(this,b,a),this.config.onLog&&this.config.onLog.call(this,b,a))};c.prototype.debug=function(b,a){this.log("DEBUG",b,a)};c.prototype.info=function(b,a){this.log("INFO",b,a)};c.prototype.warn=function(b,a){this.log("WARN",b,a)};c.prototype.error=function(b,a,f){this.log("ERROR",b+c.util.getErrorDetails(a),f)};c.prototype.clearLog=
function(){this.counter=0;this.ui.clearLog()};if(window.clipboardData)c.prototype.toClipboard=function(){window.clipboardData.setData("text",this.toString());alert("Logs copied to clipboard")};c.prototype.exportView=function(){var b=window.open("","jsLogger","width=750, height=400, location=0, resizable=1, menubar=1, scrollbars=1"),a;b&&(a=this.toString(),b.document.write("<pre>"+a+"</pre>"),b.focus())};c.prototype.setOfflineState=function(b,a){return this.config.persistState?c.util.setOfflineState(this.config.name+
b,a):null};c.prototype.getOfflineState=function(b){return this.config.persistState?c.util.getOfflineState(this.config.name+b):null};c.prototype.toString=function(){return this.ui.$log.text()};c.prototype.toArray=function(b){var a=this.toString().split("\r\n");a.pop();b===-1&&(a=a.reverse());return a};c.util={setOfflineState:function(){var b;return window.localStorage?function(a,b){localStorage.removeItem(a);localStorage[a]=b;return true}:function(a,b){var c=a+"="+escape(b);window.location.protocol.toUpperCase()==
"HTTPS:"&&(c+="; secure");document.cookie=c;return null}}(),getOfflineState:function(){var b;return window.localStorage?function(a){return localStorage[a]}:function(a){var b=a+"=",a=document.cookie,c=null,d;if(a.length>0&&(d=a.indexOf(b),d!=-1)){d+=b.length;b=a.indexOf(";",d);if(b==-1)b=a.length;c=unescape(a.substring(d,b))}return c}}(),getFormattedTime:function(){var b=new Date,a=b.getHours(),c=b.getMinutes(),e=b.getSeconds(),b=b.getMilliseconds(),a=""+a;a+=(c<10?":0":":")+c;a+=(e<10?":0":":")+e;
a+=(b<10?",0":",")+b;return a},getErrorDetails:function(b){var a="";b!=null&&b!=""&&(a="\n -- Error Info --",a+="\n name: "+b.name,a+="\n number: "+b.number,a+="\n message: "+b.message,a+="\n description: "+b.description);return a},toConsole:function(){function b(a,b){var c=a.toLowerCase(),c=console[c];typeof c=="function"?c.call(console,b):console.log(b)}return window.console?b:null}(),htmlEncode:function(b){return d("<div/>").text(b).html()}};c.UI=function(b){b.config.noCSSFile&&!d("#jslog_style").length&&
