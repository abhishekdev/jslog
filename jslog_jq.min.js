...
window.open("","jsLogger","width=750, height=400, location=0, resizable=1, menubar=1, scrollbars=1"),a;b&&(a=this.toUIString(true),b.document.write('<html><head><title>jsLog : Export View</title></head><body onLoad="self.focus()"><pre>'+a+"</pre></body></html>"))};return function(){var c=d("html").data("jslog"),a=function(){};a.prototype={clearLog:a,debug:a,error:a,getLogLevel:a,getOfflineState:a,info:a,isDebugEnabled:a,isInfoEnabled:a,isWarnEnabled:a,log:a,setLogLevel:a,setOfflineState:a,toArray:a,
toString:a,warn:a};return c===true?new b("DEBUG"):new a}()}(jQuery);
